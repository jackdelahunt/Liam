...
struct TypeChecker {
    ...
    void type_check_assert_statement(AssertStatement *statement);
    void type_check_while_statement(WhileStatement *statement);
    ...
    void type_check_range_expression(RangeExpression *expression);
